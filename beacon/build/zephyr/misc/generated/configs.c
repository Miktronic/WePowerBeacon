...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_LIS2DW12_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_LPS22HH_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_BUFFER_SIZE_DOWN, 256);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STDC_LIS2DW12, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STDC_LPS22HH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_REVISION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_WP_REV1, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRYPTO_INIT_PRIORITY, 90);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRYPTO_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRYPTO_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRYPTO_MBEDTLS_SHIM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRYPTO_MBEDTLS_SHIM_DRV_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRYPTO_MBEDTLS_SHIM_MAX_SESSION, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LIS2DW12, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LIS2DW12_TRIGGER_NONE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LPS22HH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LPS22HH_TRIGGER_GLOBAL_THREAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LPS22HH_TRIGGER, 1);
